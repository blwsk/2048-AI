...
Grid.prototype.score = function() {
  ...
  rows.forEach( function(r) {
    tiles.push.apply(tiles, r.filter(isNotNull));
  });
  ...
  // add expected value of blank tiles
  var numTiles = tiles.length;
  var numCells = 4 * 4;
  var expectedValueOfCell = (numTiles / numCells) * ((0.9 * 2) + (0.1 * 4));
  var totalEV = (numCells - numTiles) * expectedValueOfCell;
